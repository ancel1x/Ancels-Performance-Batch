...
:: Install DevManView
curl -g -k -L -# -o "C:\Windows\System32\DevManView.exe" "https://cdn.discordapp.com/attachments/1003668036345143376/1191099033457008670/DevManView.exe?ex=65a4346b&is=6591bf6b&hm=551d757b1d1e75f893510bb8c2510cda14cb154fc7a2835a697bfe08b4db4311&" >> APB_Log.txt
timeout /t 3 /nobreak > NUL
